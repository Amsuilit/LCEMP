# Minecraft LCEMP
LCEMP is a Minecraft Legacy Console Edition source fork that enables LAN multiplayer hosting along side more complete PC compatibility which has been forked from https://github.com/LCEMP/LCEMP.
